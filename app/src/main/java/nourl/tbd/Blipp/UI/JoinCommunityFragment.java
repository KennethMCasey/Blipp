...
public class JoinCommunityFragment extends Fragment implements CommunityGetterCompletion
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        communitiesJoined.setAdapter(new CommunityAdapter(this.getContext(),  new ArrayList<Community>() , true, false));
    ...
    private void getCommunity(Community communityToStartAt) {
        ...
        if (order.getSelectedItemPosition() == 0)
            ...
            new CommunityGetter(CommunityGetter.Section.DISCOVER, CommunityGetter.Order.MEMBER_COUNT_LOW_TO_HIGH, communityToStartAt, 20, this, this.getContext());

        else if (order.getSelectedItemPosition() == 2)
            new CommunityGetter(CommunityGetter.Section.DISCOVER, CommunityGetter.Order.MEMBER_COUNT_HIGH_TO_LOW, communityToStartAt, 20, this, this.getContext());
