...
public class ManageCommunitiesSelectFragment extends Fragment implements CommunityGetterCompletion {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //configure communitites list
        communitiesJoined = v.findViewById(R.id.list_community_joined);
        communitiesJoined.setAdapter(new CommunityAdapter(this.getContext(),  new ArrayList<Community>() , true, true));
        communitiesJoined.setOnScrollListener(new BottomHit());
        communitiesJoined.setOnItemClickListener(new ItemTouched());
    ...
    private class ItemTouched implements AdapterView.OnItemClickListener
    {
        @Override
